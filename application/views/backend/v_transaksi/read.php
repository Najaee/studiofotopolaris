...
<a href="<?php echo site_url('Transaksi/create') ?>"><button type="button" 
...
<table border="1" width="70%">
 ...
 <a href="<?php echo site_url('Transaksi/edit/'.$row['Id_transaksi'])?>" 
title="tombol utk merubah data">Ubah</a> |
 <!--memanggil aksi delete-->
 <a href="<?php echo site_url('Transaksi/delete/'.$row['Id_transaksi'])?>" 
